...
namespace {
struct qt_meta_tag_ZN12ParametryARXE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12ParametryARXE = QtMocHelpers::stringData(
    "ParametryARX",
    "zglosNoweParametry",
    "",
    "std::vector<double>",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ParametryARXE[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      13,    0,   51,    2, 0x08,   11 /* Private */,
      14,    0,   52,    2, 0x08,   12 /* Private */,

 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, 0x80000000 | 3, QMetaType::Int, QMetaType::Double, QMetaType::Double, QMetaType::Double, QMetaType::Double, QMetaType::Double, QMetaType::Bool,    4,    5,    6,    7,    8,    9,   10,   11,   12,
...
Q_CONSTINIT const QMetaObject ParametryARX::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ParametryARXE.offsetsAndSizes,
    qt_meta_data_ZN12ParametryARXE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ParametryARXE_t,
        // Q_OBJECT / Q_GADGET
...
void ParametryARX::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ParametryARX::*)(std::vector<double> , std::vector<double> , int , double , double , double , double , double , bool );
            if (_q_method_type _q_method = &ParametryARX::zglosNoweParametry; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ParametryARX::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ParametryARXE.stringdata0))
...
// SIGNAL 0
void ParametryARX::zglosNoweParametry(std::vector<double> _t1, std::vector<double> _t2, int _t3, double _t4, double _t5, double _t6, double _t7, double _t8, bool _t9)
{
