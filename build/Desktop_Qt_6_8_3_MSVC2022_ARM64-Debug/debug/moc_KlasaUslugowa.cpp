...
Q_CONSTINIT static const uint qt_meta_data_ZN13KlasaUslugowaE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       8,    1,   49,    2, 0x06,    7 /* Public */,
      10,    1,   52,    2, 0x06,    9 /* Public */,
...
void KlasaUslugowa::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->wyslijProbkeDoSieci((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        case 2: _t->statusWyrabiania((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->nowyPing((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        }
        {
            ...
            if (_q_method_type _q_method = &KlasaUslugowa::wyslijProbkeDoSieci; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void KlasaUslugowa::wyslijProbkeDoSieci(double _t1)
{
