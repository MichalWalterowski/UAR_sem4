...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -101, 276, 845));
        ...
        labelTryb->setEnabled(true);

        gridLayout_2->addWidget(labelTryb, 2, 0, 1, 1);

        label_4 = new QLabel(groupBox_Siec);
        ...
        labelCzyPolaczono = new QLabel(groupBox_Siec);
        labelCzyPolaczono->setObjectName("labelCzyPolaczono");
        labelCzyPolaczono->setEnabled(true);

        gridLayout_2->addWidget(labelCzyPolaczono, 3, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelTryb->setText(QCoreApplication::translate("MainWindow", "Tryb:", nullptr));
        label_4->setText(QString());
        pushPolaczSiec->setText(QCoreApplication::translate("MainWindow", "Po\305\202\304\205cz", nullptr));
        labelCzyPolaczono->setText(QCoreApplication::translate("MainWindow", "Oczekuje na po\305\202\304\205czenie...", nullptr));
